...
export const teamMembers = [
  ...
  },
  {
    ...
    focus: "Ballroom & Latin",
    bio: "Elaine has been involved with ballroom dancing since age 8 having danced & competed throughout that time. Elaine has a BA degree in Business Studies and 20 years experience in the finance industry. She has been working with WPDA for over 10 years originally as a dancer and now as a teacher.",
    extra: "In that time Elaine has won national titles in both UK and Ireland in adult & senior categories. Having completed her teaching qualifications Elaine now teaches classes within our academy across all levels. Elaine places a big focus on adult classes to help adults overcome any fears of learning to dance or returning to dancefloor as an older competitor."
  },
  {
    name: "Sinead Doyle",
    role: "Ballroom & Latin Coach",
