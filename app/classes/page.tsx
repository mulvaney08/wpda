...
const categoryImage = [classesImages.earlyYears, classesImages.childrenTeens, classesImages.adults, classesImages.specialist];
    ...
    <>
      ...
      <section className="section-wrap pb-12">
        ...
        <div className="mt-8 space-y-6">
          {classCategories.map((group, index) => (
            <article key={group.title} className="surface overflow-hidden">
              <div className="grid gap-0 lg:grid-cols-5">
                <ImagePanel image={categoryImage[index]} className="rounded-none border-0 lg:col-span-2 lg:aspect-auto" />
