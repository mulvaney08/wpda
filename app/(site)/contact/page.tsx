        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <article className="surface overflow-hidden">
            ...
            <div className="p-7">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3 text-white/85">
                {socialIconLinks.map((item) => (
                  <a
                    ...
                    title={item.platform}
                    className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/35 hover:border-gold hover:text-gold"
                  >
                    {item.icon}
                  </a>
                ))}
